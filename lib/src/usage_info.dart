...
class UsageInfo{
  int usage;
  int get usagePage => usage >> 16;
  int get usageId => usage & 0xffff;
  String get usageString => '${_toHexString(usagePage, len:4)}:${_toHexString(usageId, len:4)}';

  UsageInfo(this.usage);

  String _toHexString(int value, {int len = 2}){
    return value.toRadixString(16).toUpperCase().padLeft(len,'0');
  }

  String get usagePageName{
    if(_usagePageNames.containsKey(usagePage)){
      return _usagePageNames[usagePage]!;
    }
    else if (usagePage >= 0xFF00) {
      return 'Vendor-defined page 0x${_toHexString(usagePage, len:4)}';
    }
    else {
      return 'Unknown usage page 0x${_toHexString(usagePage, len:4)}';
    }
  }

  String get usageName{
    if (usagePage == 0x0009) {
      return 'Button$usageId';
    }
    else if (usagePage == 0x000A) {
      return 'Instance$usageId';
    }
    else if (usagePage == 0x0010) {
      return 'U+${_toHexString(usageId, len:4)}';
    }
    else if (usagePage == 0x0081) {
      return 'ENUM_$usageId';
    }
    else if(_usageNames.containsKey(usage)){
      return _usageNames[usage]!;
    }
    else {
      return 'usage 0x${_toHexString(usageId, len:4)}';
    }
  }

  @override
  String toString(){
    if(_usageNames.containsKey(usage)){
      return '$usageString ($usagePageName > ${_usageNames[usage]})';
    }
    else {
      return '$usageString ($usagePageName $usageName)';
    }
  }

  /// https://www.usb.org/document-library/hid-usage-tables-14
  final _usagePageNames = {
    // 0x0000 is Undefined
  ...
  final _usageNames = {
    ...
    0x00010092: 'D-pad Right',
    0x00010093: 'D-pad Left',
    ...
    0x000100A9: 'System Microphone Mute',
    ...
    0x000100E0: 'Call Active LED',
    0x000100E1: 'Call Mute Toggle',
    0x000100E2: 'Call Mute LED',
    // Simulation Controls
    ...
    0x00080057: 'System Microphone Mute',
    ...
    0x000C007E: 'Keyboard Backlight Set Maximum',
    ...
    0x000D006E: 'Transducer Serial Number Part 2',
    0x000D006F: 'No Preferred Color',
    ...
    0x000D00A6: 'Transducer Index Selector',
    0x000D00B0: 'Button Press Threshold',
    // Haptics
    ...
    0x000E1008: 'Waveform Hover',
    0x000E1009: 'Waveform Success',
    0x000E100A: 'Waveform Error',
    0x000E100B: 'Waveform Ink Continuous',
    0x000E100C: 'Waveform Pencil Continuous',
    0x000E100D: 'Waveform Marker Continuous',
    0x000E100E: 'Waveform Chisel Marker Continuous',
    0x000E100F: 'Waveform Brush Continuous',
    0x000E1010: 'Waveform Eraser Continuous',
    0x000E1011: 'Waveform Sparkle Continuous',
    // Physical Input Device
    0x000F0001: 'Physical Input Device',
    0x000F0020: 'Normal',
    0x000F0021: 'Set Effect Report',
    0x000F0022: 'Effect Parameter Block Index',
    0x000F0023: 'Parameter Block Offset',
    0x000F0024: 'ROM Flag',
    0x000F0025: 'Effect Type',
    0x000F0026: 'ET Constant-Force',
    0x000F0027: 'ET Ramp',
    0x000F0028: 'ET Custom-Force',
    ...
    0x000F0060: 'Center-Point Offset',
    ...
    0x000F007F: 'Parameter Block Pools Report',
    ...
    0x000F00AB: 'Create New Effect Parameter Block Report',
    0x000F00AC: 'RAM Pool Available',
    // SoC
    0x00110001: 'SocControl',
    0x00110002: 'FirmwareTransfer',
    0x00110003: 'FirmwareFileId',
    0x00110004: 'FileOffsetInBytes',
    0x00110005: 'FileTransferSizeMaxInBytes',
    0x00110006: 'FilePayload',
    0x00110007: 'FilePayloadSizeInBytes',
    0x00110008: 'FilePayloadContainsLastBytes',
    0x00110009: 'FileTransferStop',
    0x0011000A: 'FileTransferTillEnd',
    ...
    0x00200061: 'Mechanical: Boolean Switch',
    0x00200062: 'Mechanical: Boolean Switch Array',
    ...
    0x0020030C: 'Property: Firmware Version',
    ...
    0x0020042A: 'Property: Location',
    0x0020042B: 'Property: Location Desired Accuracy',
    ...
    0x002004BD: 'Data Field: Human Attention Detected',
    ...
    0x00200816: 'Sensor Event: Range Maximum Reached',
    ...
    0x002009C0: 'Human Presence Detection Type: Vendor-Defined Non-Biometric',
    0x002009C1: 'Human Presence Detection Type: Vendor-Defined Biometric',
    0x002009C2: 'Human Presence Detection Type: Facial Biometric',
    0x002009C3: 'Human Presence Detection Type: Audio Biometric',
    ...
    0x00840063: 'Voltage Out Of Range',
    ...
    0x008500F3: 'Level 3',
    // Barcode Scanner
    0x008C0001: 'Barcode Badge Reader',
    0x008C0002: 'Barcode Scanner',
    ...
    0x008C0066: 'Trigger Mode Laser stays on after release',
    ...
    0x008C00DA: 'Check Digit Enable Standard 2 of 5 OPCC',
    0x008C00DB: 'Check Digit Enable Standard 2 of 5 USS',
    ...
    0x008C0108: 'Discrete Length to Decode 1',
    0x008C0109: 'Discrete Length to Decode 2',
    ...
    0x008D0078: 'Scale Status Requires Rezeroing',
